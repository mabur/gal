...
template<typename Array>
typename Array::const_reference get_element(const Array& a, size_t i0)
{
    static_assert(a.rank() == 1, "Wrong dimensionality of the index");
    assert(i0 < a.extent0());
    return a[i0];
...
template<typename Array>
typename Array::reference get_element(Array& a, size_t i0, size_t i1)
{
...
template<typename Array>
typename Array::const_reference get_element(const Array& a, size_t i0, size_t i1)
{
    static_assert(a.rank() == 2, "Wrong dimensionality of the index");
    assert(i0 < a.extent0());
    assert(i1 < a.extent1());
...
template<typename Array>
typename Array::reference get_element(Array& a, size_t i0, size_t i1, size_t i2)
{
...
template<typename Array>
typename Array::const_reference get_element(const Array& a, size_t i0, size_t i1, size_t i2)
{
    static_assert(a.rank() == 3, "Wrong dimensionality of the index");
    assert(i0 <.extent0());
    assert(i1 <.extent1());
